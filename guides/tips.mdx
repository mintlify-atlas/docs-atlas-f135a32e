...
The `default_model` field lives at the root of the config file (not nested under `settings`).

You can also set it via environment variable: `DOCKER_AGENT_DEFAULT_MODEL=anthropic/claude-sonnet-4-0`.
